...
var style_SUMBERAIRMINUMRUMAHTANGGA2022_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Objected");
    var labelText = "";
    size = 0;
    ...
    if (value >= 65.390000 && value <= 80.642000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 80.642000 && value <= 86.126000) {
            style = [ new ol.style.Style({
